...
| Model resilience | `ModelResilienceIT` | [`model-call-testcases.md`](testcase/model-call-testcases.md) | Rate limits back off, transient failures retry only to the configured bound, and errors remain diagnosable |

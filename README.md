...
| Java tool calling | `ToolCallingIT` | [`java-tool-calling-testcases.md`](testcase/java-tool-calling-testcases.md) | Complex arguments and chained results remain exact; concurrent calls stay isolated; failing tools are not retried |

...
| --- | --- | --- | --- |
| 基础模型调用与韧性 | [model-call-testcases.md](model-call-testcases.md) | `ModelSmokeIT`、`ModelResilienceIT` | P0 / P1 / P2 |
...
当前文档与自动化的对应关系为 19 个用例：基础模型调用与韧性 5 个、流式输出 3 个、Java 工具调用
